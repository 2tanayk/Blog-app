...
-- 5. Establish the Hierarchy Chain
-- This single row automatically gives ROLE_ADMIN access to privileges 1, 2, and 3
INSERT INTO role_hierarchy (higher_role, lower_role)
VALUES ('ROLE_ADMIN', 'ROLE_USER');

-- 6. Seed an admin user (password: admin123)
...
-- 7. Assign ROLE_ADMIN to the admin user
